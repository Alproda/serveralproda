...
$hs = $_POST["hspassword"];
// CHECK PASSWORD
if($hs == /* SITE PASSWORD */ "Amr1011")
{
$hsmessage = "Password True";
$_SESSION["hs_password_true"] = $hs;
header("refresh:2;url=home.php");
}else{
$hsmessage = "Password Wrong, try Again.";
}
// end hs submit
}
...
<html>
<head>
<title>𝐁𝐘 𝐄𝐑𝐑𝐎𝐑</title>
<meta name= viewport  content= width=device-width, initial-scale=1 >
<link rel="icon" href="6666.jpg" />
<meta charset="UTF-8" />
...
<br>
<form method="POST" >
<center><input type="password" name="hspassword" placeholder="Password" ></center>
<br>
<center><button type="submit"  name="hssubmit" >Continue</button>
</center>
<br>
<center><p>✦ 𝐄𝐑𝐑𝐎𝐑 ✦</p>
<pr>
<center><a href="https://bestcash2020.com/e6IPA">Get Password</a></center>
<br>
<center><a href="https://t.me/Team_Error1/271">لو مش عارف تجيب الباسورد اضغط هنا</a></center>
<br>
</form>
</section>
<center><a href="https://t.me/FREE_NET_5_G">Telegram Channel</a></center>
